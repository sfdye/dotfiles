#!/usr/bin/env bash
#
# gh-poi-cleanup.sh — Daily cleanup of merged/closed local branches (and their
...
#
# Usage:
#   gh-poi-cleanup.sh            # delete eligible branches + worktrees
#   gh-poi-cleanup.sh --dry-run  # report only, delete nothing
#
set -uo pipefail
...
ROOT="${GH_POI_CLEANUP_ROOT:-$HOME/Code}"
